          ...
          <div class="row">
            ...
            <div class="col-md-3">
             ...
             <div class="col-md-3">
                ...
                <input type="text"  name="txtTelefono" maxlength="10" minlength="7" data-parsley-type="number" class="form-control" id="campoTelefono" placeholder="Teléfono" data-parsley-required="false">
            </div>
