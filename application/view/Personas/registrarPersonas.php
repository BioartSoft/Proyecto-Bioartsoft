      ...
      <?php endif; ?>
          ...
          <div class="col-md-3">
             ...
             <div class="col-md-3">
                ...
                <input type="text" tabindex="3" name="txtIdPersona"  minlength="8" maxlength="15" style="width: 100%"class="form-control" id="campoId" placeholder="Número Documento" data-parsley-required="true">
            </div>
